...
".FormatUsingObject(new { Filename = Filename });
                    ...
                    var Result = MessageBox.Show(Message, "Scriptor Pad", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning);
        ...
        private void menuitemFilePrint_Click(object IGNORE_sender, EventArgs IGNORE_e) {
            ...
            PrintDocument.DocumentName = DocumentName + " - Scriptor Pad";
        ...
        private void menuitemEditFindNext_Click(object sender, EventArgs e) {
            ...
            if(!FindAndSelect(_LastSearchText, _LastMatchCase, _LastSearchDown)) {
                MessageBox.Show(this, CONST.CannotFindMessage.FormatUsingObject(new { SearchText = _LastSearchText }), "Scriptor Pad");
            }
        }
